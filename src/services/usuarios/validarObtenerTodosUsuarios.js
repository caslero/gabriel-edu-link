...
export default async function validarObtenerTodosUsuarios(req) {
  try {
    ...
    return respuestasAlBack(
      "ok",
      "Validacion obtener todos los usuarios correcta...",
      {},
    );
  } catch (error) {
    console.error("Error interno validar obtener todos los usuarios:", error);

    return respuestasAlBack(
      "error",
      "Error interno validar obtener todos los usuarios...",
    );
  }
}
