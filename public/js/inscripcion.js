...
if (selectSemestre) {
    ...
    if (formManual) {
        formManual.addEventListener('submit', async (e) => {
            ...
            const estudianteId = parseInt(document.getElementById('id_estudiante_hidden')?.value || selectEstudiante?.value);
            ...
            if (!payload.estudiante_id || isNaN(payload.estudiante_id)) {
                return mostrarNotificacion("Debe buscar un estudiante primero", "error");
            }
